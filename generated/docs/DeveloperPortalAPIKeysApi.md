# mizancore_baas_generated.DeveloperPortalAPIKeysApi

All URIs are relative to *https://api.mizancore.ng*

Method | HTTP request | Description
------------- | ------------- | -------------
[**developer_api_key_index**](DeveloperPortalAPIKeysApi.md#developer_api_key_index) | **GET** /api/v1/developer/api-keys | List API keys
[**developer_api_key_revoke**](DeveloperPortalAPIKeysApi.md#developer_api_key_revoke) | **POST** /api/v1/developer/api-keys/{id}/revoke | Revoke an API key
[**developer_api_key_rotate**](DeveloperPortalAPIKeysApi.md#developer_api_key_rotate) | **POST** /api/v1/developer/api-keys/{id}/rotate | Rotate an API key
[**developer_api_key_store**](DeveloperPortalAPIKeysApi.md#developer_api_key_store) | **POST** /api/v1/developer/api-keys | Create a new API key


# **developer_api_key_index**
> VirtualAccountQueryIndex200Response developer_api_key_index(x_tenant_id)
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    api_instance = mizancore_baas_generated.DeveloperPortalAPIKeysApi(api_client)
    ...
    try:
        # List API keys
        api_response = api_instance.developer_api_key_index(x_tenant_id)
        print("The response of DeveloperPortalAPIKeysApi->developer_api_key_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalAPIKeysApi->developer_api_key_index: %s\n" % e)
```
...
# **developer_api_key_revoke**
> VirtualAccountQueryIndex200Response developer_api_key_revoke(id, x_tenant_id, revoke_api_key_request)
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    x_tenant_id = 'world.test.localhost' # str | Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.
    revoke_api_key_request = {"reason":"CI15 test cleanup"} # RevokeApiKeyRequest | 

    try:
        # Revoke an API key
        api_response = api_instance.developer_api_key_revoke(id, x_tenant_id, revoke_api_key_request)
        print("The response of DeveloperPortalAPIKeysApi->developer_api_key_revoke:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalAPIKeysApi->developer_api_key_revoke: %s\n" % e)
```
...
# **developer_api_key_rotate**
> VirtualAccountQueryIndex200Response developer_api_key_rotate(id, x_tenant_id)
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Rotate an API key
        api_response = api_instance.developer_api_key_rotate(id, x_tenant_id)
        print("The response of DeveloperPortalAPIKeysApi->developer_api_key_rotate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalAPIKeysApi->developer_api_key_rotate: %s\n" % e)
```
...
**404** | API key not found |  -  |
**400** | Bad Request — tenant routing information missing or invalid (e.g. neither Host header nor X-Tenant-ID resolved to a tenant), or X-Tenant-ID supplied in production where it is disallowed. |  -  |
**409** | API key is not active |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **developer_api_key_store**
> VirtualAccountQueryIndex200Response developer_api_key_store(x_tenant_id, create_api_key_request)
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    api_instance = mizancore_baas_generated.DeveloperPortalAPIKeysApi(api_client)
    x_tenant_id = 'world.test.localhost' # str | Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.
    create_api_key_request = {"name":"CI15 read-only key","scopes":["virtual_accounts:read","transfers:read"]} # CreateApiKeyRequest | 

    try:
        # Create a new API key
        api_response = api_instance.developer_api_key_store(x_tenant_id, create_api_key_request)
        print("The response of DeveloperPortalAPIKeysApi->developer_api_key_store:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalAPIKeysApi->developer_api_key_store: %s\n" % e)
```
