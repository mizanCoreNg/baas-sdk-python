# mizancore_baas_generated.DeveloperPortalSandboxApi

All URIs are relative to *https://api.mizancore.ng*

Method | HTTP request | Description
------------- | ------------- | -------------
[**developer_sandbox_reset**](DeveloperPortalSandboxApi.md#developer_sandbox_reset) | **POST** /api/v1/developer/sandbox/reset | Reset sandbox environment
[**developer_sandbox_status**](DeveloperPortalSandboxApi.md#developer_sandbox_status) | **GET** /api/v1/developer/sandbox/status | Get sandbox environment status
[**developer_sandbox_test_data**](DeveloperPortalSandboxApi.md#developer_sandbox_test_data) | **GET** /api/v1/developer/sandbox/test-data | Get sandbox test data patterns
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    api_instance = mizancore_baas_generated.DeveloperPortalSandboxApi(api_client)
    ...
    try:
        # Reset sandbox environment
        api_response = api_instance.developer_sandbox_reset(x_tenant_id)
        print("The response of DeveloperPortalSandboxApi->developer_sandbox_reset:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalSandboxApi->developer_sandbox_reset: %s\n" % e)
```
...
**409** | Sandbox mode is not active |  -  |
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Get sandbox environment status
        api_response = api_instance.developer_sandbox_status(x_tenant_id)
        print("The response of DeveloperPortalSandboxApi->developer_sandbox_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalSandboxApi->developer_sandbox_status: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Get sandbox test data patterns
        api_response = api_instance.developer_sandbox_test_data(x_tenant_id)
        print("The response of DeveloperPortalSandboxApi->developer_sandbox_test_data:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeveloperPortalSandboxApi->developer_sandbox_test_data: %s\n" % e)
```
