# mizancore_baas_generated.BaaSWalletApi

All URIs are relative to *https://api.mizancore.ng*

Method | HTTP request | Description
------------- | ------------- | -------------
[**developer_wallet_balance**](BaaSWalletApi.md#developer_wallet_balance) | **GET** /api/v1/developer/wallet/balance | Get wallet balance
[**developer_wallet_transactions**](BaaSWalletApi.md#developer_wallet_transactions) | **GET** /api/v1/developer/wallet/transactions | List wallet transactions
[**partner_wallet_balance**](BaaSWalletApi.md#partner_wallet_balance) | **GET** /api/v1/baas/wallet/balance | Get wallet balance
[**partner_wallet_transactions**](BaaSWalletApi.md#partner_wallet_transactions) | **GET** /api/v1/baas/wallet/transactions | List wallet transactions
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    api_instance = mizancore_baas_generated.BaaSWalletApi(api_client)
    ...
    try:
        # Get wallet balance
        api_response = api_instance.developer_wallet_balance(x_tenant_id)
        print("The response of BaaSWalletApi->developer_wallet_balance:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSWalletApi->developer_wallet_balance: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # List wallet transactions
        api_response = api_instance.developer_wallet_transactions(x_tenant_id)
        print("The response of BaaSWalletApi->developer_wallet_transactions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSWalletApi->developer_wallet_transactions: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Get wallet balance
        api_response = api_instance.partner_wallet_balance(x_tenant_id)
        print("The response of BaaSWalletApi->partner_wallet_balance:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSWalletApi->partner_wallet_balance: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # List wallet transactions
        api_response = api_instance.partner_wallet_transactions(x_tenant_id)
        print("The response of BaaSWalletApi->partner_wallet_transactions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSWalletApi->partner_wallet_transactions: %s\n" % e)
```
