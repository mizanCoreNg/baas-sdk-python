# mizancore_baas_generated.BaaSTransactionsApi

All URIs are relative to *https://api.mizancore.ng*

Method | HTTP request | Description
------------- | ------------- | -------------
[**developer_transactions_index**](BaaSTransactionsApi.md#developer_transactions_index) | **GET** /api/v1/developer/transactions | List partner transactions
[**developer_transactions_show**](BaaSTransactionsApi.md#developer_transactions_show) | **GET** /api/v1/developer/transactions/{id} | Get transaction details
[**partner_transaction_index**](BaaSTransactionsApi.md#partner_transaction_index) | **GET** /api/v1/baas/transactions | List partner transactions
[**partner_transaction_show**](BaaSTransactionsApi.md#partner_transaction_show) | **GET** /api/v1/baas/transactions/{id} | Get transaction details
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    api_instance = mizancore_baas_generated.BaaSTransactionsApi(api_client)
    ...
    try:
        # List partner transactions
        api_response = api_instance.developer_transactions_index(x_tenant_id)
        print("The response of BaaSTransactionsApi->developer_transactions_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSTransactionsApi->developer_transactions_index: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Get transaction details
        api_response = api_instance.developer_transactions_show(id, x_tenant_id)
        print("The response of BaaSTransactionsApi->developer_transactions_show:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSTransactionsApi->developer_transactions_show: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # List partner transactions
        api_response = api_instance.partner_transaction_index(x_tenant_id)
        print("The response of BaaSTransactionsApi->partner_transaction_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSTransactionsApi->partner_transaction_index: %s\n" % e)
```
...
with mizancore_baas_generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Get transaction details
        api_response = api_instance.partner_transaction_show(id, x_tenant_id)
        print("The response of BaaSTransactionsApi->partner_transaction_show:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BaaSTransactionsApi->partner_transaction_show: %s\n" % e)
```
