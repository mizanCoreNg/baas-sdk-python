...
class OpenManagedAccountRequest(BaseModel):
    """
    OpenManagedAccountRequest
    """ # noqa: E501
    product_id: Annotated[str, Field(min_length=1, strict=True)]
    nickname: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["product_id", "nickname"]
