...
class FindVirtualAccountByReferenceRequest(BaseModel):
    """
    FindVirtualAccountByReferenceRequest
    """ # noqa: E501
    customer_reference: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    __properties: ClassVar[List[str]] = ["customer_reference"]
