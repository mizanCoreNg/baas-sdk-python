...
class SandboxTestDataResource(BaseModel):
    """
    SandboxTestDataResource
    """ # noqa: E501
    test_patterns: Optional[StrictStr] = None
    documentation_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["test_patterns", "documentation_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "test_patterns": obj.get("test_patterns"),
