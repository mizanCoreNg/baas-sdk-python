...
class IssueManagedCardRequest(BaseModel):
    """
    IssueManagedCardRequest
    """ # noqa: E501
    nickname: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Optional field (included only when present in request)")
    limits: Optional[IssueManagedCardRequestLimits] = None
    __properties: ClassVar[List[str]] = ["nickname", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limits": IssueManagedCardRequestLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None
        })
        return _obj
