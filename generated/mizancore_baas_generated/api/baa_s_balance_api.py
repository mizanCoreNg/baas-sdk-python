...
class BaaSBalanceApi:
    ...
    def baas_balance_balance(
        ...
        _param = self._baas_balance_balance_serialize(
    ...
    @validate_call
    def baas_balance_balance_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def baas_balance_balance_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    def _baas_balance_balance_serialize(
        self,
        x_tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/baas/balance',
    ...
    @validate_call
    def baas_balance_fee_preview(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        fee_preview_request: FeePreviewRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_tenant_id: Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
        :type x_tenant_id: str
        :param fee_preview_request: (required)
        :type fee_preview_request: FeePreviewRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._baas_balance_fee_preview_serialize(
            x_tenant_id=x_tenant_id,
            fee_preview_request=fee_preview_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def baas_balance_fee_preview_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        fee_preview_request: FeePreviewRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def baas_balance_fee_preview_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        fee_preview_request: FeePreviewRequest,
        _request_timeout: Union[
    ...
    def _baas_balance_fee_preview_serialize(
        self,
        x_tenant_id,
        fee_preview_request,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if fee_preview_request is not None:
            _body_params = fee_preview_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/baas/withdrawals/fee-preview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def developer_withdrawals_fee_preview(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        fee_preview_request: FeePreviewRequest,
        _request_timeout: Union[
        ...
        _param = self._developer_withdrawals_fee_preview_serialize(
            x_tenant_id=x_tenant_id,
            fee_preview_request=fee_preview_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def developer_withdrawals_fee_preview_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        fee_preview_request: FeePreviewRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def developer_withdrawals_fee_preview_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        fee_preview_request: FeePreviewRequest,
        _request_timeout: Union[
    ...
    def _developer_withdrawals_fee_preview_serialize(
        self,
        x_tenant_id,
        fee_preview_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/developer/withdrawals/fee-preview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
