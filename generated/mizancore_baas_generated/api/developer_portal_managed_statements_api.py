...
class DeveloperPortalManagedStatementsApi:
    ...
    @validate_call
    def developer_accounts_statement(
        self,
        ...
        _param = self._developer_accounts_statement_serialize(
    ...
    @validate_call
    def developer_accounts_statement_with_http_info(
        self,
        account_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
    ...
    @validate_call
    def developer_accounts_statement_without_preload_content(
        self,
        account_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
    ...
    def _developer_accounts_statement_serialize(
        self,
        account_id,
        x_tenant_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/developer/accounts/{accountId}/statement',
    ...
    @validate_call
    def managed_customer_statement_show(
        self,
        account_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
        ...
        _param = self._managed_customer_statement_show_serialize(
            account_id=account_id,
            x_tenant_id=x_tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def managed_customer_statement_show_with_http_info(
        self,
        account_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
    ...
    @validate_call
    def managed_customer_statement_show_without_preload_content(
        self,
        account_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
    ...
    def _managed_customer_statement_show_serialize(
        self,
        account_id,
        x_tenant_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/baas/accounts/{accountId}/statement',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
