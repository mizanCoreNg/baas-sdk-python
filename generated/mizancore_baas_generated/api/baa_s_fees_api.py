...
class BaaSFeesApi:
    ...
    def developer_fees_index(
        ...
        _param = self._developer_fees_index_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PartnerFeeScheduleIndex200Response",
            '401': None,
            '403': None,
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def developer_fees_index_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PartnerFeeScheduleIndex200Response]:
        """Get partner fee schedule
    ...
    @validate_call
    def developer_fees_index_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    def _developer_fees_index_serialize(
        self,
        x_tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/developer/fees',
    ...
    @validate_call
    def partner_fee_schedule_index(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._partner_fee_schedule_index_serialize(
            x_tenant_id=x_tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def partner_fee_schedule_index_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def partner_fee_schedule_index_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    def _partner_fee_schedule_index_serialize(
        self,
        x_tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/baas/fees',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
