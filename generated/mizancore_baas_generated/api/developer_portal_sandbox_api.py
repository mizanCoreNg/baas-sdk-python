...
class DeveloperPortalSandboxApi:
    ...
    def developer_sandbox_reset(
        ...
        _param = self._developer_sandbox_reset_serialize(
    ...
    @validate_call
    def developer_sandbox_reset_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def developer_sandbox_reset_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    def _developer_sandbox_reset_serialize(
        self,
        x_tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/developer/sandbox/reset',
    ...
    def developer_sandbox_status(
        ...
        _param = self._developer_sandbox_status_serialize(
            x_tenant_id=x_tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def developer_sandbox_status_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def developer_sandbox_status_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    def _developer_sandbox_status_serialize(
        self,
        x_tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/developer/sandbox/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def developer_sandbox_test_data(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._developer_sandbox_test_data_serialize(
            x_tenant_id=x_tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def developer_sandbox_test_data_with_http_info(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def developer_sandbox_test_data_without_preload_content(
        self,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        _request_timeout: Union[
            None,
    ...
    def _developer_sandbox_test_data_serialize(
        self,
        x_tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/developer/sandbox/test-data',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
