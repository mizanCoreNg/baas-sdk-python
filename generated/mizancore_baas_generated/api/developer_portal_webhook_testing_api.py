...
class DeveloperPortalWebhookTestingApi:
    ...
    @validate_call
    def webhook_testing_send_test_event(
        self,
        ...
        send_test_webhook_request: SendTestWebhookRequest,
        ...
        :param send_test_webhook_request: (required)
        :type send_test_webhook_request: SendTestWebhookRequest
        ...
        _param = self._webhook_testing_send_test_event_serialize(
            subscription_id=subscription_id,
            x_tenant_id=x_tenant_id,
            send_test_webhook_request=send_test_webhook_request,
    ...
    @validate_call
    def webhook_testing_send_test_event_with_http_info(
        self,
        subscription_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        send_test_webhook_request: SendTestWebhookRequest,
    ...
    @validate_call
    def webhook_testing_send_test_event_without_preload_content(
        self,
        subscription_id: StrictStr,
        x_tenant_id: Annotated[str, Field(min_length=1, strict=True, description="Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts.")],
        send_test_webhook_request: SendTestWebhookRequest,
    ...
    def _webhook_testing_send_test_event_serialize(
        self,
        subscription_id,
        x_tenant_id,
        send_test_webhook_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if send_test_webhook_request is not None:
            _body_params = send_test_webhook_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/developer/webhooks/{subscriptionId}/test',
